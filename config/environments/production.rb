Rails.application.configure do
  ...
  config.action_mailer.default_url_options = { host: "pathway.psiapps.com" }
  ...
  # WCK commented this line out to remove "I, [2013-11-11T07:10:26.977618 #4390]  INFO -- :" prefix from log entries
