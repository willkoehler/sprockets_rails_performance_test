var msg1 = "Pathway does not support Internet Explorer 7 or older.";
var msg2 = "You must install a newer browser before using Pathway. Any of the browsers below will work."
var msg3 = "Click on one of the icons to install a newer browser.";
var br1 = "Chrome 20+";
var br2 = "Firefox 20+";
var br3 = "Internet Explorer 8+";
var br4 = "Safari 7+";
var url1 = "http://www.google.com/chrome";
var url2 = "http://www.mozilla.com/firefox/";
var url3 = "http://www.microsoft.com/windows/internet-explorer";
var url4 = "http://www.apple.com/safari/download/";

function ie6warning() {
  // Remove focus from any textboxes so cursor doesn't bleed through warning box
  window.onload = function() { document.activeElement.blur(); }
  ...
  _dl.style.top = "0px";
  _dl.style.left = "0px";
  _dl.style.filter = "alpha(opacity=85)";   // IE <= 8
  _dl.style.opacity = ".85";                // All others
  _dl.style.background = "#222";
  ...
  _dd.style.border = "1px solid #888";
  ...
  _li1ds.background = _li2ds.background = _li3ds.background = _li4ds.background = "transparent url('/ie6warning/background_browser.gif') no-repeat scroll left top";
  ...
  _li1ds.styleFloat = _li2ds.styleFloat = _li3ds.styleFloat = _li4ds.styleFloat = "left";   // IE
  _li1ds.cssFloat = _li2ds.cssFloat = _li3ds.cssFloat = _li4ds.cssFloat = "left";           // All others
  ...
  _ico1ds.background = "transparent url('/ie6warning/browser_chrome.png') no-repeat scroll left top";
  _ico2ds.background = "transparent url('/ie6warning/browser_firefox.gif') no-repeat scroll left top";
  _ico3ds.background = "transparent url('/ie6warning/browser_ie.gif') no-repeat scroll left top";
  _ico4ds.background = "transparent url('/ie6warning/browser_safari.gif') no-repeat scroll left top";
